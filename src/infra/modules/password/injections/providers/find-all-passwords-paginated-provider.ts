import { FindAllPasswordsPaginatedUseCase } from '@application/password/useCases/find-all-passwords-paginated/find-all-passwords-paginated-use-case';
...
const useFactory = (
  ...
  new FindAllPasswordsPaginatedUseCase(passwordGateway, httpExceptionGateway);

export const findAllPasswordsPaginatedProvider: Provider = {
  provide: PasswordConstants.FindAllPasswordsPaginatedUseCase,
  useFactory,
  inject: [
